...
describe("MessageBubble", () => {
	...
	it("renders assistant message", () => {
		const message = { id: "m1", sessionId: "s1", role: "assistant" as const, content: "Hi there", createdAt: 1 };
		render(<MessageBubble message={message} />);
		expect(screen.getByText("Hi there")).toBeDefined();
	});

	it("renders markdown content", () => {
		const message = { id: "m1", sessionId: "s1", role: "assistant" as const, content: "**bold** and `code`", createdAt: 1 };
		render(<MessageBubble message={message} />);
	...
	it("shows copy button for assistant messages", () => {
		const message = { id: "m1", sessionId: "s1", role: "assistant" as const, content: "Copy me", createdAt: 1 };
		render(<MessageBubble message={message} />);
	...
	it("calls onCopy when copy button is clicked", async () => {
		...
		const onCopy = vi.fn();
		const message = { id: "m1", sessionId: "s1", role: "assistant" as const, content: "text", createdAt: 1 };
	...
	it("shows edit button for user messages when onEdit provided", () => {
		const message = { id: "m1", sessionId: "s1", role: "user" as const, content: "editable", createdAt: 1 };
		render(<MessageBubble message={message} onEdit={vi.fn()} />);
		expect(screen.getByTitle("Editar mensaje")).toBeDefined();
	});

	it("shows delete button when onDelete provided", () => {
		const message = { id: "m1", sessionId: "s1", role: "user" as const, content: "delete me", createdAt: 1 };
	...
	it("renders empty content gracefully", () => {
		const message = { id: "m1", sessionId: "s1", role: "assistant" as const, content: "", createdAt: 1 };
		render(<MessageBubble message={message} />);
	});
});
